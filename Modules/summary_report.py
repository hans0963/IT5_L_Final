...
from Core.database import db   # updated import path
...
class SummaryReportWindow:
    ...
    def create_widgets(self):
        ...
        metrics = [
            ...
            ("Fines Collected", f"Php  {data['fines_collected']:.2f}"),
            ("Fines Pending", f"Php  {data['fines_pending']:.2f}")
        ]
    ...
    def get_report_data(self):
        ...
        try:
            ...
            # Updated: use 'Active' instead of 'Pending'
            ...
            # Updated: exclude Paid and Waived for pending fines
            cursor.execute("SELECT COALESCE(SUM(fine_amount), 0) FROM fines WHERE payment_status NOT IN ('Paid','Waived')")
